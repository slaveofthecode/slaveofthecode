...
Accumulated working knowledge. The `memory-update` skill appends here after every
completed task. When this file exceeds ~20 lines, fold the durable knowledge into
AGENTS.md (§8.4) and prune.
